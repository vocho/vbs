...
Sub Main
    ...
    Set objDl = xmlDoc.createElement("dl")
    
    xmlDoc.appendChild(objHtml)
    objHtml.appendChild(objBody)
    objBody.appendChild(objDl)
    
    Call FolderProc(strParentFolder, strParentFolder, xmlDoc, objDl, 0, 0, "")
...
Function FolderProc(strParentFolder, strFolderPath, xmlDoc, objParentElement, intCount, intTotalCount, strParentTree)
    ...
    With fso.GetFolder(strFolderPath)
        ...
        Set objDt = xmlDoc.createElement("dt")
        ...
        objParentElement.appendChild(objDt)
        objDt.appendChild(objTreeTt)
        objTreeTt.appendChild(objTreeText)
        objDt.appendChild(objNameA)
